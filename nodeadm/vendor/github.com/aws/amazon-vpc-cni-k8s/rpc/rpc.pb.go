...
type GetMaxAllocatableIPsReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetMaxAllocatableIPsReply) Reset() {
	*x = GetMaxAllocatableIPsReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetMaxAllocatableIPsReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMaxAllocatableIPsReply) ProtoMessage() {}

func (x *GetMaxAllocatableIPsReply) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMaxAllocatableIPsReply.ProtoReflect.Descriptor instead.
func (*GetMaxAllocatableIPsReply) Descriptor() ([]byte, []int) {
	return file_rpc_proto_rawDescGZIP(), []int{4}
}

func (x *GetMaxAllocatableIPsReply) GetMaxAllocatableIPs() int32 {
	if x != nil {
...
var file_rpc_proto_rawDesc = []byte{
	...
	0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xd3, 0x01, 0x0a, 0x0f,
	...
	0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4d, 0x6f, 0x64,
	0x65, 0x22, 0x49, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x78, 0x41, 0x6c, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x50, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x2c,
	...
	0x00, 0x12, 0x50, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x78, 0x41, 0x6c, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x50, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x1a, 0x1e, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x78, 0x41, 0x6c,
	0x6c, 0x6f, 0x63, 0x61, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x50, 0x73, 0x52, 0x65, 0x70, 0x6c,
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*GetMaxAllocatableIPsReply)(nil),     // 4: rpc.GetMaxAllocatableIPsReply
...
var file_rpc_proto_depIdxs = []int32{
	...
	10, // 2: rpc.CNIBackend.GetMaxAllocatableIPs:input_type -> google.protobuf.Empty
	...
	4,  // 8: rpc.CNIBackend.GetMaxAllocatableIPs:output_type -> rpc.GetMaxAllocatableIPsReply
...
func file_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetMaxAllocatableIPsReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CNIBackendClient interface {
	...
	GetMaxAllocatableIPs(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMaxAllocatableIPsReply, error)
}
...
func (c *cNIBackendClient) GetMaxAllocatableIPs(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMaxAllocatableIPsReply, error) {
	out := new(GetMaxAllocatableIPsReply)
	err := c.cc.Invoke(ctx, "/rpc.CNIBackend/GetMaxAllocatableIPs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CNIBackendServer interface {
	...
	GetMaxAllocatableIPs(context.Context, *emptypb.Empty) (*GetMaxAllocatableIPsReply, error)
}
...
func (*UnimplementedCNIBackendServer) GetMaxAllocatableIPs(context.Context, *emptypb.Empty) (*GetMaxAllocatableIPsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMaxAllocatableIPs not implemented")
}
...
func _CNIBackend_GetMaxAllocatableIPs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CNIBackendServer).GetMaxAllocatableIPs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.CNIBackend/GetMaxAllocatableIPs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CNIBackendServer).GetMaxAllocatableIPs(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CNIBackend_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMaxAllocatableIPs",
			Handler:    _CNIBackend_GetMaxAllocatableIPs_Handler,
		},
	},
