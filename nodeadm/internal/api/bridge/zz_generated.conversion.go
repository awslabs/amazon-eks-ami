...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.EnvironmentOptions)(nil), (*api.EnvironmentOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions(a.(*v1alpha1.EnvironmentOptions), b.(*api.EnvironmentOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.EnvironmentOptions)(nil), (*v1alpha1.EnvironmentOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions(a.(*api.EnvironmentOptions), b.(*v1alpha1.EnvironmentOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions(in *v1alpha1.EnvironmentOptions, out *api.EnvironmentOptions, s conversion.Scope) error {
	out.Default = *(*map[string]string)(unsafe.Pointer(&in.Default))
	out.SystemdKubelet = *(*map[string]string)(unsafe.Pointer(&in.SystemdKubelet))
	out.SystemdContainerd = *(*map[string]string)(unsafe.Pointer(&in.SystemdContainerd))
	return nil
}

// Convert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions is an autogenerated conversion function.
func Convert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions(in *v1alpha1.EnvironmentOptions, out *api.EnvironmentOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions(in, out, s)
}

func autoConvert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions(in *api.EnvironmentOptions, out *v1alpha1.EnvironmentOptions, s conversion.Scope) error {
	out.Default = *(*map[string]string)(unsafe.Pointer(&in.Default))
	out.SystemdKubelet = *(*map[string]string)(unsafe.Pointer(&in.SystemdKubelet))
	out.SystemdContainerd = *(*map[string]string)(unsafe.Pointer(&in.SystemdContainerd))
	return nil
...
// Convert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions is an autogenerated conversion function.
func Convert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions(in *api.EnvironmentOptions, out *v1alpha1.EnvironmentOptions, s conversion.Scope) error {
	return autoConvert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions(in, out, s)
}
...
func autoConvert_v1alpha1_InstanceOptions_To_api_InstanceOptions(in *v1alpha1.InstanceOptions, out *api.InstanceOptions, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_EnvironmentOptions_To_api_EnvironmentOptions(&in.Environment, &out.Environment, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_api_InstanceOptions_To_v1alpha1_InstanceOptions(in *api.InstanceOptions, out *v1alpha1.InstanceOptions, s conversion.Scope) error {
	...
	if err := Convert_api_EnvironmentOptions_To_v1alpha1_EnvironmentOptions(&in.Environment, &out.Environment, s); err != nil {
		return err
	}
	return nil
}
