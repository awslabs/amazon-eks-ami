...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.DiagnosticsOptions)(nil), (*api.DiagnosticsOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions(a.(*v1alpha1.DiagnosticsOptions), b.(*api.DiagnosticsOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.DiagnosticsOptions)(nil), (*v1alpha1.DiagnosticsOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions(a.(*api.DiagnosticsOptions), b.(*v1alpha1.DiagnosticsOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions(in *v1alpha1.DiagnosticsOptions, out *api.DiagnosticsOptions, s conversion.Scope) error {
	out.DiagnosticsS3UploadURI = in.DiagnosticsS3UploadURI
	return nil
}

// Convert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions is an autogenerated conversion function.
func Convert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions(in *v1alpha1.DiagnosticsOptions, out *api.DiagnosticsOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions(in, out, s)
}

func autoConvert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions(in *api.DiagnosticsOptions, out *v1alpha1.DiagnosticsOptions, s conversion.Scope) error {
	out.DiagnosticsS3UploadURI = in.DiagnosticsS3UploadURI
	return nil
}

// Convert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions is an autogenerated conversion function.
func Convert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions(in *api.DiagnosticsOptions, out *v1alpha1.DiagnosticsOptions, s conversion.Scope) error {
	return autoConvert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions(in, out, s)
}
...
func autoConvert_v1alpha1_NodeConfigSpec_To_api_NodeConfigSpec(in *v1alpha1.NodeConfigSpec, out *api.NodeConfigSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_DiagnosticsOptions_To_api_DiagnosticsOptions(&in.DiagnosticsOptions, &out.DiagnosticsOptions, s); err != nil {
		return err
	}
...
func autoConvert_api_NodeConfigSpec_To_v1alpha1_NodeConfigSpec(in *api.NodeConfigSpec, out *v1alpha1.NodeConfigSpec, s conversion.Scope) error {
	...
	if err := Convert_api_DiagnosticsOptions_To_v1alpha1_DiagnosticsOptions(&in.DiagnosticsOptions, &out.DiagnosticsOptions, s); err != nil {
		return err
	}
