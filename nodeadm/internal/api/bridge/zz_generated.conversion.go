...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.NetworkOptions)(nil), (*api.NetworkOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkOptions_To_api_NetworkOptions(a.(*v1alpha1.NetworkOptions), b.(*api.NetworkOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NetworkOptions)(nil), (*v1alpha1.NetworkOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NetworkOptions_To_v1alpha1_NetworkOptions(a.(*api.NetworkOptions), b.(*v1alpha1.NetworkOptions), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.VolumeMount)(nil), (*api.VolumeMount)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VolumeMount_To_api_VolumeMount(a.(*v1alpha1.VolumeMount), b.(*api.VolumeMount), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.VolumeMount)(nil), (*v1alpha1.VolumeMount)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_VolumeMount_To_v1alpha1_VolumeMount(a.(*api.VolumeMount), b.(*v1alpha1.VolumeMount), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_InstanceOptions_To_api_InstanceOptions(in *v1alpha1.InstanceOptions, out *api.InstanceOptions, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_NetworkOptions_To_api_NetworkOptions(&in.Network, &out.Network, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_api_InstanceOptions_To_v1alpha1_InstanceOptions(in *api.InstanceOptions, out *v1alpha1.InstanceOptions, s conversion.Scope) error {
	...
	if err := Convert_api_NetworkOptions_To_v1alpha1_NetworkOptions(&in.Network, &out.Network, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_NetworkOptions_To_api_NetworkOptions(in *v1alpha1.NetworkOptions, out *api.NetworkOptions, s conversion.Scope) error {
	out.Nameservers = *(*[]string)(unsafe.Pointer(&in.Nameservers))
	out.Domains = *(*[]string)(unsafe.Pointer(&in.Domains))
	return nil
}

// Convert_v1alpha1_NetworkOptions_To_api_NetworkOptions is an autogenerated conversion function.
func Convert_v1alpha1_NetworkOptions_To_api_NetworkOptions(in *v1alpha1.NetworkOptions, out *api.NetworkOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkOptions_To_api_NetworkOptions(in, out, s)
}

func autoConvert_api_NetworkOptions_To_v1alpha1_NetworkOptions(in *api.NetworkOptions, out *v1alpha1.NetworkOptions, s conversion.Scope) error {
	out.Nameservers = *(*[]string)(unsafe.Pointer(&in.Nameservers))
	out.Domains = *(*[]string)(unsafe.Pointer(&in.Domains))
	return nil
}

// Convert_api_NetworkOptions_To_v1alpha1_NetworkOptions is an autogenerated conversion function.
func Convert_api_NetworkOptions_To_v1alpha1_NetworkOptions(in *api.NetworkOptions, out *v1alpha1.NetworkOptions, s conversion.Scope) error {
	return autoConvert_api_NetworkOptions_To_v1alpha1_NetworkOptions(in, out, s)
}
...
func autoConvert_v1alpha1_StorageOptions_To_api_StorageOptions(in *v1alpha1.StorageOptions, out *api.StorageOptions, s conversion.Scope) error {
	out.Volumes = *(*[]api.VolumeMount)(unsafe.Pointer(&in.Volumes))
	return nil
}
...
func autoConvert_api_StorageOptions_To_v1alpha1_StorageOptions(in *api.StorageOptions, out *v1alpha1.StorageOptions, s conversion.Scope) error {
	out.Volumes = *(*[]v1alpha1.VolumeMount)(unsafe.Pointer(&in.Volumes))
	return nil
}
...
// Convert_v1alpha1_VolumeMount_To_api_VolumeMount is an autogenerated conversion function.
func Convert_v1alpha1_VolumeMount_To_api_VolumeMount(in *v1alpha1.VolumeMount, out *api.VolumeMount, s conversion.Scope) error {
	return autoConvert_v1alpha1_VolumeMount_To_api_VolumeMount(in, out, s)
}
...
// Convert_api_VolumeMount_To_v1alpha1_VolumeMount is an autogenerated conversion function.
func Convert_api_VolumeMount_To_v1alpha1_VolumeMount(in *api.VolumeMount, out *v1alpha1.VolumeMount, s conversion.Scope) error {
	return autoConvert_api_VolumeMount_To_v1alpha1_VolumeMount(in, out, s)
}
