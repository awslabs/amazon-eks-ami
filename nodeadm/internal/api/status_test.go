...
`
	validTwoNetworkInterfaceDetails = []NetworkInterfaceDetails{
		{MAC: "06:83:e7:fe:fe:fe", IpV4Address: "1.2.3.4", NetworkCardIndex: 1, DeviceNumber: 1},
		{MAC: "06:83:e7:ff:ff:ff", IpV4Address: "5.6.7.8", NetworkCardIndex: 0, DeviceNumber: 0},
	}

	validOneNetworkInterfaceDetails = []NetworkInterfaceDetails{
		{MAC: "06:83:e7:fb:fb:fb", IpV4Address: "1.2.3.4", NetworkCardIndex: 0, DeviceNumber: 0},
	}
