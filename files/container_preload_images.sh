...
sudo docker pull public.ecr.aws/eks-distro/coredns/coredns:v1.8.7-eks-1-22-6
sudo docker pull 602401143452.dkr.ecr.eu-central-1.amazonaws.com/eks/aws-ebs-csi-driver:v1.5.1
...
sudo docker pull k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.5.0
...
sudo docker pull public.ecr.aws/aws-ec2/aws-node-termination-handler:v1.16.1
sudo docker pull public.ecr.aws/aws-observability/aws-for-fluent-bit:2.21.4
sudo docker pull public.ecr.aws/aws-observability/aws-for-fluent-bit:2.23.3
sudo docker pull quay.io/cilium/cilium:v1.11.2
sudo docker pull quay.io/cilium/cilium:v1.11.4
