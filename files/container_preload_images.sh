...
sudo docker pull ghcr.io/sylr/traefik:v2.8.7_sylr.1
sudo docker pull 602401143452.dkr.ecr.eu-central-1.amazonaws.com/eks/aws-ebs-csi-driver:v1.11.2
...
sudo docker pull public.ecr.aws/aws-ec2/aws-node-termination-handler:v1.17.2
