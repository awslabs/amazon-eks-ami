...
sudo docker pull ghcr.io/sylr/traefik:v2.8.1_sylr.1
...
sudo docker pull quay.io/cilium/cilium:v1.11.6
sudo docker pull quay.io/cilium/cilium:v1.11.7
sudo docker pull quay.io/cilium/cilium:v1.12.0
