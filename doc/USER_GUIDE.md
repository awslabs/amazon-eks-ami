...
When building an AMI, you can set the `kernel_version` to `4.14`, `5.4`, or `5.10` to customize the kernel version.
...
For Kubernetes version 1.24 and above, it uses the `5.10` kernel if not set.
