...
ISOLATED_REGIONS="${ISOLATED_REGIONS:-us-iso-east-1 us-iso-west-1 us-isob-east-1 eu-isoe-west-1 us-isof-south-1 us-isof-east-1}"
...
elif [ "$BINARY_BUCKET_REGION" = "us-isof-east-1" ]; then
  S3_DOMAIN="csp.hci.ic.gov"
fi
