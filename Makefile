...
1.13:
	...
	$(MAKE) k8s kubernetes_version=1.13.7 kubernetes_build_date=2019-08-14

.PHONY: 1.13.g3
1.13.g3:
	$(MAKE) k8s kubernetes_version=1.13.8 kubernetes_build_date=2019-08-14 instance_type=g3.4xlarge
