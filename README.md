...
This repo is a fork of the [Amazon EKS AMI Build Specification](https://github.com/awslabs/amazon-eks-ami) with a few modifications for kata-containers (via this blog post: https://aws.amazon.com/blogs/containers/enhancing-kubernetes-workload-isolation-and-security-using-kata-containers/):

- create the devmapper snapshotter: https://github.com/browserbase/amazon-eks-ami/commit/a206a8950169b6a0274584eda1a93840e2ad0732 and https://github.com/browserbase/amazon-eks-ami/commit/c7d024a3e1d0c51e610039f6ba65167791b0efaa
- set up the systemd daemon service to initialize the thin-pool on reload: https://github.com/browserbase/amazon-eks-ami/commit/837d3e40e5799eb0a7714715290aecde00b19e78
- update containerd to v2: https://github.com/browserbase/amazon-eks-ami/commit/d2009c79a75f4f12d3ba2d35d71252417e10c403
...
make k8s=... os_distro=al2023 vpc_id=vpc-... subnet_id=subnet-...
```
